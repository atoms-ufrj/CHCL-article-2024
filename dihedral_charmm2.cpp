...
DihedralCharmm2::DihedralCharmm2(LAMMPS *lmp) : Dihedral(lmp)
{
  weightflag = 0;
  writedata = 1;
}
...
DihedralCharmm2::~DihedralCharmm2()
{
...
void DihedralCharmm2::compute(int eflag, int vflag)
{
...
void DihedralCharmm2::coeff(int narg, char **arg)
{
...
void DihedralCharmm2::init_style()
{
...
void DihedralCharmm2::write_restart(FILE *fp)
{
...
void DihedralCharmm2::read_restart(FILE *fp)
{
  allocate();
...
void DihedralCharmm2::write_data(FILE *fp)
{
  for (int i = 1; i <= atom->ndihedraltypes; i++)
