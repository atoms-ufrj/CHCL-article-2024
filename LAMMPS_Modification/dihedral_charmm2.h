...
// clang-format off
DihedralStyle(charmm2,DihedralCharmm2);
// clang-format on
#else

#ifndef LMP_DIHEDRAL_CHARMM2_H
#define LMP_DIHEDRAL_CHARMM2_H

#include "dihedral.h"

namespace LAMMPS_NS {

class DihedralCharmm2 : public Dihedral {
 public:
  DihedralCharmm2(class LAMMPS *);
  virtual ~DihedralCharmm2();
